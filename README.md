...
### Route:
  ...
  # 10. /userNotification/:id : PATCH
    # update status of user notification via params userNotification id
  ...
  # 31. /groupMember/:id : DELETE
    # deling groupMember via groupMember id on params
  # 32. /groupMessage : POST
    # creating group message via req.body 
  # 33. /groupMessage/:groupChatId : GET
    # get all data where group chat id = params group chat id
